 ...
 */
public final class WWJMPreLoadConstants {
	public static final String PROJECT_ID = "Japanese Maples - Wilder Wild";
	public static final String MOD_ID = "wilderwild_japanese_maple";
