...
public final class WWJMFeatureUtils {

	private WWJMFeatureUtils() {
		throw new UnsupportedOperationException("WWJMFeatureUtils contains only static declarations.");
	}
	...
	public static <FC extends FeatureConfiguration, F extends Feature<FC>> FrozenLibConfiguredFeature<FC> register(@NotNull String id, F feature, @NotNull FC config) {
		FrozenLibConfiguredFeature<FC> frozen = new FrozenLibConfiguredFeature<>(WWJMConstants.id(id));
	...
	public static <FC extends FeatureConfiguration> FrozenLibConfiguredFeature<FC> register(@NotNull String id) {
		return new FrozenLibConfiguredFeature<>(WWJMConstants.id(id));
	}
