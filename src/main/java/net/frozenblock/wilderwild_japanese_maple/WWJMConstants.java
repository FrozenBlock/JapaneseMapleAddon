...
public final class WWJMConstants {
	public static final String PROJECT_ID = WWJMPreLoadConstants.PROJECT_ID;
	public static final String MOD_ID = WWJMPreLoadConstants.MOD_ID;
	public static final Logger LOGGER = WWJMPreLoadConstants.LOGGER;
	/**
